...
// Task 2: Sequence number is always a 0 or a 1 
#define MAX_SEQ 2  
...
void *client_thread_func(void *arg) 
{
    ...
    for (int request_index = 0; request_index < num_requests; request_index++) 
    {
        ...
        // Task 2: Implement Automatic Repeat Request (ARQ): Keep trying to send frame until either acknowledged or maximum retries is reached
